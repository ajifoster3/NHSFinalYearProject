...
public enum PatientHeadersEnum {
    ...
    rass("The Richmond agitation-sedation scale (RASS) is used to monitor the level of a patient’s sedation whilst also evaluating any agitated behaviour. It runs on a scale between -5 and +4"),
    ...
    PatientHeadersEnum(String code) {
        this.code = code;
    }
